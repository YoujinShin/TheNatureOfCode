...
//    mynumber = createFont("DS-Digital", 32);
  ...
  void display(PImage img_, int quality_, int cd_, int state_, int pop_, int income_) {
...
//////////////////////////////////////////// STATE 2 ///////////////////////////////////////////
  ...
  void enterText() {
    ...
    fill(255);
    textSize(60);
    text("CHILD DEATH",  width/2 + 250, height/2 - 110); //width/2 + 250, height/2 -120); // width/2 -2*20+ 330, height/2 -100

    fill(150);
    textSize(20);
    
    text("FROM DIARRHEA", width/2 +250, height/2 - 70); //  width/2 -2*20+ 330, height/2 - 50
  ...
  void enterTextPeople() {
    ...
    textAlign(LEFT);
    textSize(20);
    text(" =  "+popRatio+" person, "+quality+"%", width/2 + 230, height/2 - 120 + 50);
